...
class BadgeSampling(Strategy):
    ...
    def query(self, n):
        ...
        gradEmbedding = self.get_grad_embedding(self.X_img[idxs_unlabeled], self.X_txt[idxs_unlabeled], self.Y[idxs_unlabeled]).numpy()
        chosen = init_centers(gradEmbedding, n)

        return idxs_unlabeled[chosen], embeddings, probs, probs, chosen, None
