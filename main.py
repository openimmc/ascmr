...
def al_train_sub_experiment(args, train_args, train_params, strategy_name, general_path, seed):
    ...
    best_mAP, best_i2t, best_t2i = strategy.train(name='0')
    ...
    result_writer.writerow([mAP[0], i2t[0], t2i[0], 0.])
    result_file.flush()
    ...
    for rd in range(1, args.n_round + 1):
        ...
        print('Testing mAP {}'.format(mAP[rd]))
        writer.add_scalar('test_mAP', mAP[rd], rd)
        writer.add_scalar('i2t_mAP', i2t[rd], rd)
        writer.add_scalar('t2i_mAP', t2i[rd], rd)
        result_writer.writerow([mAP[rd], i2t[rd], t2i[rd], duration])
        result_file.flush()
...
if __name__ == "__main__":
    ...
    dataset = parser.parse_known_args()[0].data_name
